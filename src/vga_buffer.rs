#[allow(dead_code)] // Used to disable warning on unused enums
#[derive(Debug, Clone, Copy, PartialEq, Eq)] // Enable copy semantics on the enum
#[repr(u8)] // All stored as 8 bits
pub enum Color {
    Black = 0,
    Blue = 1,
    Green = 2,
